...
},{"fbjs/lib/invariant":"../node_modules/fbjs/lib/invariant.js","fbjs/lib/warning":"../node_modules/fbjs/lib/warning.js","./lib/ReactPropTypesSecret":"../node_modules/prop-types/lib/ReactPropTypesSecret.js"}],"../node_modules/react/cjs/react.development.js":[function(require,module,exports) {
...
if ("development" !== "production") {
  (function () {
    ...
    var camelizeStyleName = require('fbjs/lib/camelizeStyleName'); // Relying on the `invariant()` implementation lets us
    // have preserve the format and params in the www builds.
    ...
    function getEventTarget(nativeEvent) {
      var target = nativeEvent.target || window; // Normalize SVG <use> element events #4963
    ...
    var Snapshot =
    /*              */
    2048; // Union of all host effects
    ...
    function trapBubbledEvent(topLevelType, handlerBaseName, element) {
      ...
      addEventBubbleListener(element, handlerBaseName, // Check if interactive and wrap in interactiveUpdates
    ...
    function trapCapturedEvent(topLevelType, handlerBaseName, element) {
      ...
      var dispatch = isInteractiveTopLevelEventType(topLevelType) ? dispatchInteractiveEvent : dispatchEvent;
      addEventCaptureListener(element, handlerBaseName, // Check if interactive and wrap in interactiveUpdates
      dispatch.bind(null, topLevelType));
    }
    ...
    };
    {
      ...
      var pendingUnsafeLifecycleWarnings = new Map(); // Tracks components we have already warned about.
      ...
      ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = function (fiber, instance) {
        var strictRoot = getStrictRoot(fiber); // Dedup strategy: Warn once per component.
    ...
    var alwaysUseRequestIdleCallbackPolyfill = false; // Only used in www builds.
    ...
    function ensureUpdateQueues(fiber) {
      q1 = q2 = null; // We'll have at least one and at most two distinct update queues.
      ...
      queue2 = queue2 !== queue1 ? queue2 : null; // Use module variables instead of returning a tuple
    ...
    function insertUpdateIntoFiber(fiber, update) {
      ...
      var queue1 = q1;
      var queue2 = q2; // Warn if an update is scheduled from inside an updater function.
    ...
    var ReactFiberClassComponent = function (legacyContext, scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState) {
      var cacheContext = legacyContext.cacheContext,
          ...
          hasContextChanged = legacyContext.hasContextChanged; // Class component state updater
      ...
      function constructClassInstance(workInProgress, props) {
        ...
        var context = needsContext ? getMaskedContext(workInProgress, unmaskedContext) : emptyObject; // Instantiate twice to help detect side-effects.
      ...
      function resumeMountClassInstance(workInProgress, renderExpirationTime) {
        ...
        var hasNewLifecycles = typeof ctor.getDerivedStateFromProps === 'function' || typeof instance.getSnapshotBeforeUpdate === 'function'; // Note: During these life-cycles, instance.props/instance.state are what
        ...
        if (workInProgress.updateQueue !== null) {
          ...
          if (updateQueue !== null && updateQueue.capturedValues !== null && enableGetDerivedStateFromCatch && typeof ctor.getDerivedStateFromCatch === 'function') {
            var capturedValues = updateQueue.capturedValues; // Don't remove these from the update queue yet. We need them in
    ...
    var ReactFiberBeginWork = function (config, hostContext, legacyContext, newContext, hydrationContext, scheduleWork, computeExpirationForFiber) {
      ...
      function updateFragment(current, workInProgress) {
        ...
        if (hasLegacyContextChanged()) {// Normally we can bail out on props equality but if context has changed
      ...
      function mountIndeterminateComponent(current, workInProgress, renderExpirationTime) {
        ...
        if (typeof value === 'object' && value !== null && typeof value.render === 'function' && value.$$typeof === undefined) {
          var Component = workInProgress.type; // Proceed under the assumption that this is a class instance
      ...
      function updateCallComponent(current, workInProgress, renderExpirationTime) {
        ...
        if (hasLegacyContextChanged()) {// Normally we can bail out on props equality but if context has changed
          ...
          nextProps = workInProgress.memoizedProps; // TODO: When bailing out, we might need to return the stateNode instead
        ...
        memoizeProps(workInProgress, nextProps); // This doesn't take arbitrary time so we could synchronously just begin
      ...
      function updateContextProvider(current, workInProgress, renderExpirationTime) {
        ...
        if (oldProps === null) {
          ...
          if (oldProps.value === newProps.value) {
            ...
            var oldValue = oldProps.value; // Use Object.is to compare the new context value to the old value.
    ...
    var ReactFiberCompleteWork = function (config, hostContext, legacyContext, newContext, hydrationContext) {
      ...
      function moveCallToHandlerPhase(current, workInProgress, renderExpirationTime) {
        ...
        !props ? invariant(false, 'Should be resolved by now. This error is likely caused by a bug in React. Please file an issue.') : void 0; // First step of the call has completed. Now we need to do the second.
          ...
          case HostComponent:
            {
              ...
              if (current !== null && workInProgress.stateNode != null) {
                ...
                if (wasHydrated) {
                  ...
                  appendAllChildren(_instance2, workInProgress); // Certain renderers require commit-time effects for initial mount.
    ...
    var ReactFiberCommitWork = function (config, captureError, scheduleWork, computeExpirationForFiber, markLegacyErrorBoundaryAsFailed, recalculateCurrentTime) {
      ...
      function commitLifeCycles(finishedRoot, current, finishedWork, currentTime, committedExpirationTime) {
        switch (finishedWork.tag) {
          ...
          case HostComponent:
            {
              var _instance4 = finishedWork.stateNode; // Renderers may schedule work to be done after host components are mounted
    ...
    var ReactFiberLegacyContext = function (stack) {
      var createCursor = stack.createCursor,
          push = stack.push,
          pop = stack.pop; // A cursor to the current merged context object on the stack.
    ...
    var ReactFiberScheduler = function (config) {
      ...
      var mostRecentCurrentTimeMs = originalStartTimeMs; // Used to ensure computeUniqueAsyncExpiration is monotonically increases.
      ...
      function commitRoot(finishedWork) {
        ...
        var currentTime = recalculateCurrentTime(); // Reset this to null before calling lifecycles
        ...
        while (nextEffect !== null) {
          ...
          if (didError) {
            ...
            onCommitPhaseError(nextEffect, error); // Clean-up
        ...
        stopCommitSnapshotEffectsTimer(); // Commit all the side-effects within a tree. We'll do this in two passes.
        ...
        while (nextEffect !== null) {
          ...
          if (_didError) {
            !(nextEffect !== null) ? invariant(false, 'Should have next effect. This error is likely caused by a bug in React. Please file an issue.') : void 0;
            onCommitPhaseError(nextEffect, _error); // Clean-up
      ...
      function renderRoot(root, expirationTime, isAsync) {
        ...
        isWorking = false; // Yield back to main thread.
        ...
        if (didFatal) {
          ...
          if (isRootReadyForCommit) {
            ...
            stopWorkLoopTimer(interruptedBy, didCompleteRoot);
            interruptedBy = null; // The root successfully completed. It's ready for commit.
          ...
          stopWorkLoopTimer(interruptedBy, didCompleteRoot);
          interruptedBy = null; // There's more work to do, but we ran out of time. Yield back to
          // the renderer.
      ...
      function dispatch(sourceFiber, value, expirationTime) {
        !(!isWorking || isCommitting) ? invariant(false, 'dispatch: Cannot dispatch during the render phase.') : void 0; // TODO: Handle arrays
      ...
      function computeInteractiveExpiration(currentTime) {
        var expirationMs = void 0; // We intentionally set a higher expiration time for interactive updates in
      ...
      var completedBatches = null; // Use these to prevent an infinite loop of nested updates
    ...
    var validateDOMNesting$1 = validateDOMNesting; // TODO: This type is shared between the reconciler and ReactDOM, but will
    ...
    ReactBatch.prototype.commit = function () {
      ...
      this._defer = false;
      DOMRenderer.flushRoot(internalRoot, expirationTime); // Pop the batch from the list.
...
},{"./factoryWithTypeCheckers":"../node_modules/react-router-dom/node_modules/prop-types/factoryWithTypeCheckers.js"}],"../node_modules/history/node_modules/warning/browser.js":[function(require,module,exports) {
/**
...
exports.default = _default;
},{"warning":"../node_modules/warning/warning.js","react":"../node_modules/react/index.js","prop-types":"../node_modules/react-router-dom/node_modules/prop-types/index.js","history":"../node_modules/history/es/index.js","./Router":"../node_modules/react-router-dom/es/Router.js"}],"../node_modules/react-router-dom/es/HashRouter.js":[function(require,module,exports) {
"use strict";
...
var _default = Link;
exports.default = _default;
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/react-router-dom/node_modules/prop-types/index.js","invariant":"../node_modules/invariant/browser.js","history":"../node_modules/history/es/index.js"}],"../node_modules/react-router/es/MemoryRouter.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"warning":"../node_modules/warning/warning.js","react":"../node_modules/react/index.js","prop-types":"../node_modules/react-router/node_modules/prop-types/index.js","history":"../node_modules/history/es/index.js","./Router":"../node_modules/react-router/es/Router.js"}],"../node_modules/react-router-dom/es/MemoryRouter.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"warning":"../node_modules/warning/warning.js","invariant":"../node_modules/invariant/browser.js","react":"../node_modules/react/index.js","prop-types":"../node_modules/react-router/node_modules/prop-types/index.js","history":"../node_modules/history/es/index.js","./Router":"../node_modules/react-router/es/Router.js"}],"../node_modules/react-router-dom/es/StaticRouter.js":[function(require,module,exports) {
"use strict";
...
var Context = _react.default.createContext('app');
...
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"pages/home/index.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      return _react.default.createElement(_context.Consumer, null, function (_ref) {
        ...
        return _react.default.createElement("div", null, state.name);
      });
    }
  }]);
...
},{"react":"../node_modules/react/index.js","../../context":"context.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
(0, _reactDom.render)(_react.default.createElement(_context.default, null, _react.default.createElement(_reactRouterDom.BrowserRouter, null, _react.default.createElement(_home.default, null))), document.querySelector('#app'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","react-router-dom":"../node_modules/react-router-dom/es/index.js","./context":"context.js","./pages/home":"pages/home/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
